...
public class AvmImplDeployAndRunTest {
    ...
    public void testBalanceTransferUpperBound() {
        ...
        AvmTransactionResult result = avmRule.balanceTransfer(new Address(from.toBytes()), account1, BigInteger.valueOf(100_000L), 21_000L, maxEnergyPrice).getTransactionResult();
    ...
    public void testBalanceTransferUpperBoundRefund() {
        ...
        Address account1 = avmRule.getRandomAddress(BigInteger.ZERO);
        long maxEnergyPrice = Long.MAX_VALUE;
        AvmTransactionResult result = avmRule.balanceTransfer(new Address(from.toBytes()), account1, BigInteger.valueOf(100_000L), 2_000_000L, maxEnergyPrice).getTransactionResult();
