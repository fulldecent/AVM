...
public class DeploymentArgumentTest {
    ...
    public void testCorrectArguments() {
        AvmTransactionResult result = deployContract("string", new Address[] {DEPLOYER_API}, (int)5, (double)6.7, SMALL_JAR);
        Assert.assertEquals(AvmTransactionResult.Code.SUCCESS, result.getResultCode());
    }

    @Test
    public void testIncorrectArguments() {
        AvmTransactionResult result = deployContract(new String[] {"string", "wrong"}, new Address[] {DEPLOYER_API}, (int)5, (double)6.7);
